...
using imagecompress::imagepipeline::getRotationTypeFromDegrees;
using imagecompress::imagepipeline::RotationType;
using imagecompress::imagepipeline::ScaleFactor;
using imagecompress::imagepipeline::jpeg::transformJpeg;
